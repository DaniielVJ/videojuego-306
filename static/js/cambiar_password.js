/* =============================================
   FORUM / RUNIC PAGE — cambiar_password.js
   (Sin canvas, solo comportamiento del formulario)
   ============================================= */
...
(function () {
  ...
  /* ─────────────────────────────────────────
     FORMULARIO CAMBIAR PASSWORD Y VALIDACIÓN
     ───────────────────────────────────────── */
  const form = document.getElementById('changePasswordForm');

  if (form) {
    form.addEventListener('submit', function (e) {
      const inputs = form.querySelectorAll('input[type="password"], input.password-visible');
      let isValid = true;
